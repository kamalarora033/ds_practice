...
/**
 * IVRWhiteListIpProcessor checks the request ip in the defined whitelisted ips.
 * If request ip not found in whitelisted ips then request will be dropped.
 * 
 * @author Ericsson
 */
public class FulfillmentWhiteListIpProcessor extends AbstractFulfillmentProcessor {
