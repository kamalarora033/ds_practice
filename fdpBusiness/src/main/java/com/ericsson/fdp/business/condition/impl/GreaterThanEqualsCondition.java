...
/**
 * The class defines the greater than equals condition.
 * 
 * @author Ericsson
 * 
 */
public class GreaterThanEqualsCondition extends AbstractCondition {

	/**
	 * The serial version id.
	 */
	private static final long serialVersionUID = -3118515733745186961L;
	...
	/**
	 * The constructor for the greater than equals condition.
	 * 
	 * @param rightOperandToSet
	 *            The right operand value to set.
	 */
	public GreaterThanEqualsCondition(final CommandParamInput rightOperandToSet) {
		super();
	...
	public String toString() {
		return " greater than or equals'" + rightOperand.toString(true) + "'";
	}
	...
	public boolean evaluateConditionValueForProvidedInput(Object leftOperandValue, Object[] rightOperandValues)
		...
		//System.out.println("inside greater than equal to");
