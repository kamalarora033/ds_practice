 ...
 * @author Ericsson
 */
public class AbilitySOAPAdapterRequest extends SOAPAdapterRequest {
	...
	public AbilitySOAPAdapterRequest(String requestId, String circleCode, String circleName,
