 ...
 * 
 */
public class RSDeprovisioningRequestNode extends SpecialMenuNode implements FDPCustomNode {
	 ...
	 */
	public RSDeprovisioningRequestNode(final String displayNameToSet, final String shortCodeToSet,
	...
	private String getSPId(final FDPRequest fdpRequest) {
		return ServiceProvDataConverterUtil.getKeyForServiceProvMetaBag(getEntityId(), FDPServiceProvType.PRODUCT,
				FDPServiceProvSubType.RS_DEPROVISION_PRODUCT);
	}
