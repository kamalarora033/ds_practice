...
/**
 * This is the class file for view usage fulfillment service.
 * 
 * @author Ericsson
 * 
 */
@Stateless
public class ViewUsageFulFillmentServiceImpl extends AbstractFDPFulFillmentServiceImpl{
	...
	protected FDPResponse executeService(FDPRequest fdpRequest, Object... additionalInformations)
		...
		if(null == fdpResponse
			...
			updateSPInRequestForProductId(productIdLong,
					FDPServiceProvSubType.SHARED_ACCOUNT_VIEW_USAGE_UC, fulfillmentRequestImpl);
			...
			if(null != fdpResponse && Status.SUCCESS.equals(fdpResponse.getExecutionStatus())) {
				...
				updateSPInRequestForProductId(productIdLong,
						FDPServiceProvSubType.SHARED_ACCOUNT_VIEW_USAGE_UT, fulfillmentRequestImpl);
				fdpResponse = executeSP(fulfillmentRequestImpl);
