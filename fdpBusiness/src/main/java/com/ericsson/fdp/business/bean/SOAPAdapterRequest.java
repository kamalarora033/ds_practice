 ...
 * @author Ericsson
 */
public class SOAPAdapterRequest extends AdapterRequestImpl {
	 ...
	 *            the circle name
	 */
	public SOAPAdapterRequest(final String requestId, final String circleCode, final String circleName,
