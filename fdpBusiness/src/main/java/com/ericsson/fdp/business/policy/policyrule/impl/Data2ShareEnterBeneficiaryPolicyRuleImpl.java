...
/**
 * This class is used to take user input for Beneficiary MSISDN for Data to transfer
 * @author GUR21122
 * @version 1.0
 * @since 2017-10-15
 *
...
public class Data2ShareEnterBeneficiaryPolicyRuleImpl extends ProductPolicyRuleImpl {
	...
	public String getNotificationText(FDPRequest fdpRequest) {
		String notificationText = getConfigurationMapValue(fdpRequest,
				ConfigurationKey.DATA2SHARE_ENTER_BENEFICIARY_MSISDN_TEXT);
		if (notificationText == null || notificationText.isEmpty()) {
			notificationText = "Enter Beneficiary Mobile Number";
		}
	...
	private String getErrorNotification(FDPRequest fdpRequest) {
		String notificationText = getConfigurationMapValue(fdpRequest,
				ConfigurationKey.DATA2SHARE_ENTER_BENEFICIARY_MSISDN_INVALID_TEXT);
		if (notificationText == null || notificationText.isEmpty()) {
			notificationText = "Please Enter a valid MSISDN";
		}
		return notificationText;
	}
