...
/**
 * The class defines the less than condition.
 * 
 * @author Ericsson
 * 
 */
public class LessThanCondition extends AbstractCondition {
	 ...
	 */
	private static final long serialVersionUID = -3980759507522742862L;
	...
	/**
	 * The constructor for the less than condition class.
	 * 
	 * @param rightOperandToSet
	 *            The right operand value to set.
	 */
	public LessThanCondition(final CommandParamInput rightOperandToSet) {
		super();
		if (rightOperandToSet == null) {
			throw new IllegalArgumentException("Found 'null' argument for condition");
		}
		super.setConditionType(FDPCommandParameterConditionEnum.IS_LESS_THAN_EQUAL_TO);
		this.rightOperand = rightOperandToSet;
	}

	@Override
	public String toString() {
		return " less than '" + rightOperand.toString(true) + "'";
	}
	...
	public boolean evaluateConditionValueForProvidedInput(Object leftOperandValue, Object[] rightOperandValues)
		...
		//System.out.println("in less than condition");
