...
public class ContainsCondition extends AbstractCondition {
	 ...
	 */
	public ContainsCondition(final List<CommandParamInput> possibleValuesToSet) {
		super();
	...
	public boolean evaluateConditionValueForProvidedInput(final Object leftOperandValue,
		...
		if (rightOperandValues[0] instanceof List<?>) {
			...
			// Evaluate the Rule
			if (possibleValuesToUse.get(FDPConstant.FIRST_INDEX) instanceof String
					&& leftOperandValue instanceof String) {
