package com.ericsson.fdp.business.smsc.throtller.impl;
 ...
 */
@Stateless
public class ThrotllerWaterGateImpl extends RoutePolicySupport {
...
//
//	/**
//	 * The Constant DATA_CACHE. private static final MetaDataRouteCache ROUTE_DATA_CACHE =
//	 * MetaDataRouteCache.getInstance();
//	 */
//
//	/** The route count. */
...
//
//	/**
//	 * Throttles the route when {@link Exchange}s is done and check all incoming rate of the MO messages. When incoming
//	 * rate gets exceeded by its normal rate then it stops the consumer. As soon as incoming MO rate gets normal then it
//	 * simply resume the route.
...
//			}
//
//			String circleId = (String) exchange.getIn().getHeader(BusinessConstants.CIRCLE_ID);
...
//			
//			Map<String, AtomicInteger> countMap = (ConcurrentHashMap<String, AtomicInteger>) applicationConfigCache.getValue(appBag);
//
//			if (countMap != null) {
...
//
//	/**
//	 * This method is used to put the routeId in map if it absent and initialize by zero(0) , Also increases the count
//	 * by one on latest value of routeId(as key).
//	 * 
//	 * @param exchange contains Exchange Object reference.
//	 * @param routeId the route id.
//	 */
...
//
//	/**
//	 * On the invocation of this method it simply decreases the count of routeId in Map.
//	 * 
//	 * @param exchange contains Exchange Object reference.
//	 * @param routeId the route id.
//	 */
...
//	 */
//	/*
//	 * private int getSize(final Route route, final Exchange exchange) { if (scope == ThrottlingScope.Context) { return
