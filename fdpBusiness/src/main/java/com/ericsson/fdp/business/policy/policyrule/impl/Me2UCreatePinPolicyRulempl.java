...
/**
 * This class is used the take user input for Me2U Pin and and save it into database in MD5 format
 * @author GUR21122
 * @version 1.0
 * @since 2017-10-15
 *
...
public class Me2UCreatePinPolicyRulempl extends ProductPolicyRuleImpl{
private static final long serialVersionUID = 1L;
	...
	public String getNotificationText(FDPRequest fdpRequest) {
		String notificationText = getConfigurationMapValue(fdpRequest,
				ConfigurationKey.ME2U_CREATE_PIN_TEXT);
		if (notificationText == null || notificationText.isEmpty()) {
			notificationText = "Please Enter a 4 digit PIN";
		}
	...
	/**
	 * This method will retrun error notification text
	 * @param fdpRequest
	 * @return
	 */
