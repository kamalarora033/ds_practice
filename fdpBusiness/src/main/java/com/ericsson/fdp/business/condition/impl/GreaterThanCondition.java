...
/**
 * The class defines the greater than condition.
 * 
 * @author Ericsson
 * 
 */
public class GreaterThanCondition extends AbstractCondition {
	 ...
	 */
	private static final long serialVersionUID = -4112014059370777170L;
	...
	/**
	 * The constructor for greater than condition.
	 * 
	 * @param rightHandOperandToSet
	 *            The right hand operand value to set.
	 */
	public GreaterThanCondition(final CommandParamInput rightHandOperandToSet) {
		super();
		if (rightHandOperandToSet == null) {
			throw new IllegalArgumentException("Found 'null' argument for condition");
		}
		super.setConditionType(FDPCommandParameterConditionEnum.IS_GREATER_THAN);
		this.rightOperand = rightHandOperandToSet;
	}

	@Override
	public String toString() {
		return " greater than '" + rightOperand.toString(true) + "'";
	}
